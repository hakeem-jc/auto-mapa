...
const MapComponent: React.FC = () => {
  ...
  const [selectedMarker, setSelectedMarker] = useState<GeocodedLocation | null>(null);
  ...
  return (
    <>
      {isLoaded ? (
        ...
        <div className="flex justify-center items-center min-h-screen bg-gray-900" role="status">
          <svg
            aria-hidden="true"
